...
const AddAssetHtmlPlugion = require('add-asset-html-webpack-plugin')
// 导入其他配置文件信息
...
const commonConfig = {
    ...
    plugins: [
        ...
        new webpack.DllReferencePlugin({
            context: resolveAppPath('./'),
            manifest: resolveAppPath('./dll/react.manifest.json')
        }),
        new AddAssetHtmlPlugion({
            typeOfAsset: 'js',
            filepath: resolveAppPath('./dll/dll_react.js'),
            outputPath: './js',
            publicPath: 'js'
        })
    ]
